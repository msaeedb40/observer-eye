...
urlpatterns = [
    ...
    path('api/v1/', include([
        ...
        path('traffic/', include('traffic.urls', namespace='traffic')),
        ...
        path('logstach/', include('logstach.urls', namespace='logstach')),
        path('cloud/', include('cloud.urls', namespace='cloud')),
        path('cloud-perf/', include('cloud_performance_monitoring.urls', namespace='cloud_performance_monitoring')),
    ])),
]
